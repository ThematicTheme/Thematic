...
Tags: white, three-columns, two-columns, fixed-layout, theme-options, left-sidebar, right-sidebar, threaded-comments, sticky-post, microformats, translation-ready, featured-images, custom-menu
...
* Updated: Tags in readme.txt and style.css
